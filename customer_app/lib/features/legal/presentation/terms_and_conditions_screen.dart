...
import 'package:yelo_laundry_customer/features/legal/data/terms_and_conditions_content.dart';
...
class TermsAndConditionsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const DashboardPageHeader(title: 'Syarat & Ketentuan'),
          Expanded(
            child: ListView(
                ...
                PickupDashboardCard(
                  child: Column(
                    ...
                    children: [
                                ...
                                Text.rich(
                                  TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text: TermsAndConditionsContent.lastUpdated,
                                        style: _poppins(
                                          fontSize: 13,
                      ...
                      const SizedBox(height: AppSpacing.s16),
                      ...TermsAndConditionsContent.sections.map(_buildSection),
                      TextButton(
